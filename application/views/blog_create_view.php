				...
				<article class="blog_create blue_text_container">
					...
					<?= form_open($form_destination, array('class' => 'form-horizontal blog_create_form')) ?>
						...
						<div class="control-group">
							...
							<div class="controls">
								<?= form_textarea(array('name' => 'content', 'id' => 'form_content', 'class' => 'span8 insert_markitup', 'placeholder' => 'Make sure to convert all characters into entities!', 'value' => set_value('content'))) ?>
